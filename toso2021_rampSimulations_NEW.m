...
histogram(sps(2),...
    ...
    'facealpha',1,...
    'linewidth',1.5);
stairs(sps(2),gamma_edges,[gamma_counts_non,gamma_counts_non(end)],...
    'color','k',...
    'linewidth',1.5);
histogram(sps(2),...
    'binedges',gamma_edges,...
...
histogram(sps(2),...
    ...
    'facealpha',.5,...
    'linewidth',1.5);
stairs(sps(2),gamma_edges,[gamma_counts_ramp,gamma_counts_ramp(end)],...
    'color','k',...
    'linewidth',1.5);
...
histogram(sps(3),...
    ...
    'facealpha',1,...
    'linewidth',1.5);
stairs(sps(3),lambda_edges,[lambda_counts_non,lambda_counts_non(end)],...
    'color','k',...
    'linewidth',1.5);
histogram(sps(3),...
    'binedges',lambda_edges,...
...
histogram(sps(3),...
    ...
    'facealpha',.5,...
    'linewidth',1.5);
stairs(sps(3),lambda_edges,[lambda_counts_ramp,lambda_counts_ramp(end)],...
    'color','k',...
    'linewidth',1.5);
...
xlabel(sps(3),'Firing rate range (Hz)');

% model selection
model2plot = M;
tunings2plot = TUNING(:,:,model2plot);
frranges2plot = FR_RANGE(:,:,model2plot);
stereotypys2plot = STEREOTYPY(:,:,model2plot);
ramps2plot_flags = SELECTED_RAMP_FLAGS(:,:,model2plot);

% bin settings
n_bins = 30;
tuning_bounds = roi;
stereotypy_bounds = [0,25];
frrange_bounds = [0,tf];
tuning_edges = linspace(tuning_bounds(1),tuning_bounds(2),n_bins);
stereotypy_edges = linspace(stereotypy_bounds(1),stereotypy_bounds(2),n_bins);
frrange_edges = linspace(frrange_bounds(1),frrange_bounds(2),n_bins);

% compute metric distributions
tuning_counts_ramp = histcounts(tunings2plot(ramps2plot_flags),tuning_edges);
tuning_counts_non = histcounts(tunings2plot(~ramps2plot_flags),tuning_edges);
stereotypy_counts_ramp = histcounts(stereotypys2plot(ramps2plot_flags),stereotypy_edges);
stereotypy_counts_non = histcounts(stereotypys2plot(~ramps2plot_flags),stereotypy_edges);
frrange_counts_ramp = histcounts(frranges2plot(ramps2plot_flags),frrange_edges);
frrange_counts_non = histcounts(frranges2plot(~ramps2plot_flags),frrange_edges);

% convert to PDF
tuning_counts_ramp = tuning_counts_ramp ./ nansum(tuning_counts_ramp);
tuning_counts_non = tuning_counts_non ./ nansum(tuning_counts_non);
stereotypy_counts_ramp = stereotypy_counts_ramp ./ nansum(stereotypy_counts_ramp);
stereotypy_counts_non = stereotypy_counts_non ./ nansum(stereotypy_counts_non);
frrange_counts_ramp = frrange_counts_ramp ./ nansum(frrange_counts_ramp);
frrange_counts_non = frrange_counts_non ./ nansum(frrange_counts_non);

% plot tuning distributions
histogram(sps(1),...
    'binedges',tuning_edges,...
    'bincounts',tuning_counts_non,...
    'facecolor',ramp_clrs(2,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
stairs(sps(1),tuning_edges,[tuning_counts_non,tuning_counts_non(end)],...
    'color','k',...
    'linewidth',1.5);
histogram(sps(1),...
    'binedges',tuning_edges,...
    'bincounts',tuning_counts_ramp,...
    'facecolor',ramp_clrs(1,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
histogram(sps(1),...
    ...
    'facealpha',.5,...
    'linewidth',1.5);
stairs(sps(1),tuning_edges,[tuning_counts_ramp,tuning_counts_ramp(end)],...
    'color','k',...
    'linewidth',1.5);

% plot firing rate range distributions
histogram(sps(3),...
    'binedges',frrange_edges,...
    'bincounts',frrange_counts_non,...
    'facecolor',ramp_clrs(2,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
stairs(sps(3),frrange_edges,[frrange_counts_non,frrange_counts_non(end)],...
    'color','k',...
    'linewidth',1.5);
histogram(sps(3),...
    'binedges',frrange_edges,...
    'bincounts',frrange_counts_ramp,...
    'facecolor',ramp_clrs(1,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
histogram(sps(3),...
    ...
    'facealpha',.5,...
    'linewidth',1.5);
stairs(sps(3),frrange_edges,[frrange_counts_ramp,frrange_counts_ramp(end)],...
    'color','k',...
    'linewidth',1.5);

% plot stereotypy distributions
histogram(sps(2),...
    'binedges',stereotypy_edges,...
    'bincounts',stereotypy_counts_non,...
    'facecolor',ramp_clrs(2,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
stairs(sps(2),stereotypy_edges,[stereotypy_counts_non,stereotypy_counts_non(end)],...
    'color','k',...
    'linewidth',1.5);
histogram(sps(2),...
    'binedges',stereotypy_edges,...
    'bincounts',stereotypy_counts_ramp,...
    'facecolor',ramp_clrs(1,:),...
    'edgecolor','none',...
    'facealpha',1,...
    'linewidth',1.5);
histogram(sps(2),...
    ...
    'facealpha',.5,...
    'linewidth',1.5);
stairs(sps(2),stereotypy_edges,[stereotypy_counts_ramp,stereotypy_counts_ramp(end)],...
    'color','k',...
    'linewidth',1.5);
...
set(sps(2),...
    'xlim',frrange_bounds,...
    'xtick',frrange_bounds);
set(sps(3),...
    'xlim',stereotypy_bounds,...
    'xtick',stereotypy_bounds);
