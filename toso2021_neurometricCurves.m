...
%
conditions.train = intersectconditions(...
    't1',t1(valid_flags),t_set,0,...([1:2,end-1:end]),0,...[],...
    'i1',i1(valid_flags),[],1,...i_set(i1_mode_idx),...
    't2',t2(valid_flags),t_set,1,...
    'i2',i2(valid_flags),[],1,...i_set(i2_mode_idx),1,...
    'choice',choice(valid_flags),choice_set,1);
conditions.test = intersectconditions(...
    't1',t1(valid_flags),t_set,1,...
    'i1',i1(valid_flags),[],1,...
    't2',t2(valid_flags),t_set,1,...
    'i2',i2(valid_flags),[],1,...
