...
for nn = 1 : n_neurons2plot
    ...
    % axes updates
    set(sps(1+n_cols),...
        'ylim',[1,sum(s1_boundaries)]+[-1,1]*.5,...
        'ytick',[1;cumsum(s1_boundaries)]);
    set(sps(2+n_cols),...
        'ylim',[1,sum(s2_boundaries)]+[-1,1]*.5,...
        'ytick',[1;cumsum(s2_boundaries)]);
    set(sps(3+n_cols),...
        'ylim',[1,sum(go_boundaries)]+[-1,1]*.5,...
        'ytick',[1;cumsum(go_boundaries)]);
