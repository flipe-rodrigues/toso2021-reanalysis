...
for ii = 1 : n_contrasts
    ...
    % plot S1 offset
    s1_offset_flags = roi2plot_time <= 0 & ...
        [roi2plot_time(2:end),nan] > 0;
    plot3(isi_score(s1_offset_flags,1,ii),...
        isi_score(s1_offset_flags,2,ii),...
        isi_score(s1_offset_flags,3,ii),...
        'linewidth',linewidth,...
        'marker','o',...
...
for jj = 1 : 3
    ...
    for ii = 1 : n_contrasts
        ...
        s1_offset_flags = roi2plot_time <= 0 & ...
            [roi2plot_time(2:end),nan] > 0;
        plot3(wall_ii_score(s1_offset_flags,1,ii),...
            wall_ii_score(s1_offset_flags,2,ii),...
            wall_ii_score(s1_offset_flags,3,ii),...
            'linewidth',wall_linewidth,...
            'marker','o',...
...
for pc = 1 : n_pcs2plot
    ...
    for ii = 1 : n_contrasts
        ...
        s1_offset_flags = roi2plot_time <= 0 & ...
            [roi2plot_time(2:end),nan] > 0;
        plot(sps(pc),roi2plot_time(s1_offset_flags),...
            isi_score(s1_offset_flags,pc,ii),...
            'linewidth',1.5,...
            'marker','o',...
            'markersize',6,...
            'markerfacecolor','w',...
...
for ii = 1 : n_contrasts
    ...
    s1_offset_flags = roi2plot_time <= 0 & ...
        [roi2plot_time(2:end),nan] > 0;
    p(ii) = plot(S(1,s1_offset_flags,ii),...
        S(2,s1_offset_flags,ii),...
        'linewidth',linewidth,...
        'marker','o',...
        'markersize',markersize,...
        'markerfacecolor','w',...
