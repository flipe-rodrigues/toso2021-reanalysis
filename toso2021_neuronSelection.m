...
if strcmpi(task_str,'duration')
    neurons2exclude_i1 = [...
        ...
        57,58,64,65,66,67,68,74,77,78,80,87,89,91,95,97,128,134,142,136,144,...
        149,150,154,159,164,166,170,171,173,185,188,194,195,204,205,...
        206,214,215,217,219,228,230,...
        240,241,243,257,259,269,274,277,278,280,281,283,298,305,314,328,334,...
        336,339,345,349,350,351,...
        356,363,365,369,370,378,380,384,386,389,390,397,405,407,414,...
        415,417,421,426,433,437,...
        438,447,455,456,459,467,468,474,477,485,490,498,500,504,505,...
        509,523,531,535,...
        542,544,548,558,571,575,579,583,587,594,599];
    neurons2exclude_i2 = [...
        4,8,9,14,15,16,17,18,19,20,21,23,26,29,36,37,38,41,45,51,58,59,...
        60,63,71,73,75,79,82,83,86,88,...
        92,93,96,99,100,102,105,107,112,143,153,155,157,160,167,179,...
        181,183,184,186,...
        187,192,197,198,201,202,205,212,226,239,249,252,253,254,256,258,...
        259,261,263,265,266,267,273,276,285,289,307,325,326,340,347,...
        348,359,360,...
        361,362,371,374,375,379,398,399,400,429,430,431,432,440,442,...
        444,449,450,...
        451,452,453,484,506,507,510,512,516,517,518,522,539,541,557,562,572,578,...
        584,585,586,596,601,602];
    neurons2exclude = unique([neurons2exclude_i1,neurons2exclude_i2]);
