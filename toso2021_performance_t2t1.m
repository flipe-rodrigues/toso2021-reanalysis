...
for ss = n_subjects : -1 : 1
    ...
    plot(ntd_set(1+(psycurves(ss).x>.5))+offset,...
        ...
        'linestyle','none',...
        'linewidth',1.5);
    plot(repmat(ntd_set(1),floor(n_stimuli/2),1)+offset,...
        psycurves(ss).y(1:floor(n_stimuli/2))./...
        psycurves(ss).n(1:floor(n_stimuli/2)),...
        'marker','none',...
        'color',clr,...
        'linestyle','-',...
        'linewidth',1.5);
    plot(repmat(ntd_set(2),floor(n_stimuli/2),1)+offset,...
        psycurves(ss).y(ceil(n_stimuli/2)+1:end)./...
        psycurves(ss).n(ceil(n_stimuli/2)+1:end),...
        'marker','none',...
        'color',clr,...
        'linestyle','-',...
        'linewidth',1.5);
