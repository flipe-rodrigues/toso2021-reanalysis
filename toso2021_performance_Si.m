...
% compute NTD level associated with each numerator value
ntd_by_numerator = nan(numerator_count,1);
...
for ii = 1 : numerator_count
    ...
    ntd_by_numerator(ii) = ntd_set(ntd_idx);
end
...
for ss = 1 : n_subjects
    ...
    % iterate through NTD levels
    for kk = 1 : n_ntd
        ntd_flags = ntd_by_numerator == ntd_set(kk);
        
        % plot subject's performance
        plot(numerator_normset(ntd_flags)+offset,...
            numerator_subj_perf(ntd_flags,ss),...
            'color',subject_clr,...
            'marker','o',...
            'markersize',6.5,...
...
for kk = 1 : n_ntd
    ...
    plot(numerator_normset(ntd_flags),...
        numerator_perf(ntd_flags),...
        'color','k',...
        'marker','o',...
        'markersize',psyopt.plot.markersize,...
        'markeredgecolor','k',...
...
for ss = 1 : n_subjects
    ...
    % NTD-crossing line
    plot(ntd_set+offset,...
        psycurves(ss).y(floor(numerator_count/2)+(0:n_ntd-1))./...
        psycurves(ss).n(floor(numerator_count/2)+(0:n_ntd-1)),...
        'color',subject_clr,...
        'linestyle','--',...
        'linewidth',1.5);
    ...
    for kk = 1 : n_ntd
        ...
        % plot subject's performance
        plot(ntd_by_numerator(ntd_flags)+offset,...
            numerator_subj_perf(ntd_flags,ss),...
            'color',subject_clr,...
            'marker','o',...
            'markersize',6.5,...
...
% NTD-crossing line
plot(ntd_set,...
    bigpsy.y(floor(numerator_count/2)+(0:n_ntd-1))./...
    bigpsy.n(floor(numerator_count/2)+(0:n_ntd-1)),...
    'color','k',...
    'linestyle','--',...
    'linewidth',1.5);
...
for kk = 1 : n_ntd
    ...
    plot(ntd_by_numerator(ntd_flags),...
