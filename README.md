...
- Fits a generalized linear model (GLM) to choice data using _T1_, _T2_, _I1_ & _I2_ as predictors;
<img src="panels/choice_GLM.svg" width="500"/>

### toso2021_trialTypeDistributions.m
- Plots the joint distribution of trial counts and _T2_s that neurons were recorded for;
...
<img src="panels/overall_modulation_i1.svg" width="500"/>
...
- Same as above, but using choice as contrast;
