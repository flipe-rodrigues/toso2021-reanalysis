...
%                 end
        ...
        plot(s1epoch_idcs+[-1,1]*barwidth*n_regressors/2,[1,1]*yymax,...
            'linestyle','-',...
            'linewidth',3,...
            'color',stim_clrs(1,:));
        ...
        plot(s2epoch_idcs+[-1,1]*barwidth*n_regressors/2,[1,1]*yymax,...
            'linestyle','-',...
            'linewidth',3,...
            'color',stim_clrs(2,:));
                ...
                for bb = 1 : n_coeffs2plot
                    ...
                    if ee == 1 && alphas(aa) == max(alphas)
                        text(x-.025,yymax*.95,coeff_str,...
                            ...
                            'rotation',90);
                        if bb == 1
                            plot(1+[-1,1]*barwidth*n_regressors/2,[1,1]*yymax,...
                                'color','k',...
                                'linewidth',1.5);
                    ...
                    for ss = 1 : 2
                        ...
                        P(bb,ss) = p;
                        if alphas(aa) == max(alphas) && coeff_idx == n_coeffs2plot
                            xstairs = ...
        ...
        for ss = 1 : n_coeffsets
            ...
            ylabel('P(significant \beta)');
            
            % reference lines
            plot(xlim,[1,1]*min(alphas),':k');
            plot(xlim,[1,1]*max(alphas),':k');
            plot([find(ismember(epochs,'postS1Onset')),...
                find(ismember(epochs,'preS1Offset'))],[1,1]*max(yylim),...
                'linestyle','-',...
                'linewidth',3,...
                'color',stim_clrs(1,:));
            plot([find(ismember(epochs,'postS2Onset')),...
                find(ismember(epochs,'preS2Offset'))],[1,1]*max(yylim),...
                'linestyle','-',...
                'linewidth',3,...
                'color',stim_clrs(2,:));
