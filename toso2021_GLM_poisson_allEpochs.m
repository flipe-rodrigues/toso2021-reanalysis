    ...
    for aa = 1 : n_alphas
        ...
        for ss = 1 : 2
            p_falsenegative_onset(gg,aa) = p_falsenegative_onset(gg,aa) - ...
                fractions.(glm_str).postS2Onset.I_2(aa,ss);
            p_falsenegative_offset(gg,aa) = p_falsenegative_offset(gg,aa) - ...
                fractions.(glm_str).preS2Offset.I_2(aa,ss);
        end
    end
end
    ...
    for aa = 1 : n_alphas
        ...
        for ss = 1 : 2
            p_falsepositive_onset(gg,aa) = p_falsepositive_onset(gg,aa) + ...
                fractions.(glm_str).postS1Onset.I_2(aa,ss);
            p_falsepositive_offset(gg,aa) = p_falsepositive_offset(gg,aa) + ...
                fractions.(glm_str).preS1Offset.I_2(aa,ss);
        end
    end
end
