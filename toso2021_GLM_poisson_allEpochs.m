...
%         X = [d1,d2,trial_idcs];
        ...
        for ee = 1 : n_epochs
            ...
            x_offsets = ee + (0 : n_regressors - 1) * barwidth + ...
            ...
            for aa = 1 : n_alphas
                ...
                for bb = 2 : n_coefficients - 1
                    coeff_lbl = mdl.CoefficientNames{bb};
...
% preallocation
p_falsenegative_onset = ones(n_glm,2);
p_falsenegative_offset = ones(n_glm,2);
...
for gg = 1 : n_glm
    ...
    for aa = 1 : n_alphas
        ...
        % iterate through signs
        for ss = 1 : 2
            p_falsenegative_onset(gg,aa) = p_falsenegative_onset(gg,aa) - ...
                nanmean(fractions.(glm_str).postS2Onset.I_2(:,aa,ss));
            p_falsenegative_offset(gg,aa) = p_falsenegative_offset(gg,aa) - ...
                nanmean(fractions.(glm_str).preS2Offset.I_2(:,aa,ss));
        end
    end
end
...
for aa = 1 : n_alphas
    ...
    plot(glm_wins,p_falsenegative_offset(:,aa),...
        'color','k',...
        'marker','s',...
        'markeredgecolor','k',...
    ...
    % plot false negative rate
    plot(glm_wins,p_falsenegative_onset(:,aa),...
        'color','k',...
        'marker','o',...
        'markeredgecolor','k',...
        'markerfacecolor','none',...
...
% preallocation
p_falsepositive_onset = zeros(n_glm,2);
p_falsepositive_offset = zeros(n_glm,2);
...
for gg = 1 : n_glm
    ...
    for aa = 1 : n_alphas
        ...
        % iterate through signs
        for ss = 1 : 2
            p_falsepositive_onset(gg,aa) = p_falsepositive_onset(gg,aa) + ...
                nanmean(fractions.(glm_str).postS1Onset.I_2(:,aa,ss));
            p_falsepositive_offset(gg,aa) = p_falsepositive_offset(gg,aa) + ...
                nanmean(fractions.(glm_str).preS1Offset.I_2(:,aa,ss));
        end
    end
end
...
for aa = 1 : n_alphas
    ...
    plot(glm_wins,p_falsepositive_offset(:,aa),...
        'color','k',...
        'marker','s',...
        'markeredgecolor','k',...
        'markerfacecolor','none',...
    ...
    % plot false positive rate
    plot(glm_wins,p_falsepositive_onset(:,aa),...
        'color','k',...
        'marker','o',...
        'markeredgecolor','k',...
        'markerfacecolor','none',...
