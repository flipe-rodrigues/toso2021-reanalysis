...
% preallocation
p_falsenegative = ones(n_glm,2);
p_falsepositive = zeros(n_glm,2);
...
for gg = 1 : n_glm
    ...
    for aa = 1 : n_alphas
        ...
        % iterate through signs
        for ss = 1 : 2
            p_falsenegative(gg,aa) = p_falsenegative(gg,aa) - ...
                fractions.(glm_str).postS2Onset.(coeff2plot)(aa,ss);
            p_falsepositive(gg,aa) = p_falsepositive(gg,aa) + ...
                fractions.(glm_str).postS1Onset.(coeff2plot)(aa,ss);
        end
    end
end
