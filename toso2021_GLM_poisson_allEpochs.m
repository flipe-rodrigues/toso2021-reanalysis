...
%                 end
        ...
        coeffs2use = mdl.CoefficientNames(2:end-1);
        n_coeffs2use = numel(coeffs2use);
        coeffs2plot = {...
            ...'T_1','T_2',...
            'I_1','I_2',...
            };
        coeffidcs2plot = find(ismember(coeffs2use,coeffs2plot));
        n_coeffs2plot = numel(coeffs2plot);
        
        % bar width settings
        epoch_span = 3 / 4;
        barwidth = epoch_span / n_coeffs2use;
        ...
        fig = figure(figopt,...
            ...
            distro,glm_win,strrep([coeffs2plot{:}],'_','')),...
            'color',[1,1,1]*1);
...
%         plot(xlim,[1,1]*-max(alphas),':k');
        ...
        plot(s1epoch_idcs+[-1,1]*barwidth*n_coeffs2use/2,[1,1]*yymax,...
            'linestyle','-',...
            'linewidth',3,...
            'color',stim_clrs(1,:));
        ...
        plot(s2epoch_idcs+[-1,1]*barwidth*n_coeffs2use/2,[1,1]*yymax,...
            'linestyle','-',...
            'linewidth',3,...
            'color',stim_clrs(2,:));
        ...
        for ee = 1 : n_epochs
            ...
            x_offsets = ee + (0 : n_coeffs2use - 1) * barwidth + ...
                barwidth / 2 - epoch_span / 2;
            
            %
%             temp = pvals.(epoch)(:,6);
%             pvals.(epoch)(:,6) = pvals.(epoch)(:,5);
%             pvals.(epoch)(:,5) = temp;
%             
%             temp = betas.(epoch)(:,6);
%             betas.(epoch)(:,6) = betas.(epoch)(:,5);
%             betas.(epoch)(:,5) = temp;
%             
%             temp = boot_betas.(epoch)(:,6,:);
%             boot_betas.(epoch)(:,6,:) = boot_betas.(epoch)(:,5,:);
%             boot_betas.(epoch)(:,5,:) = temp;
%             continue;
                ...
                for bb = 1 : n_coeffs2plot
                    ...
                    if ee == 1 && alphas(aa) == max(alphas)
                        text(x-.025,yymax*.95,coeff_str,...
                            ...
                            'rotation',90);
                        if bb == 1
                            plot(1+[-1,1]*barwidth*n_coeffs2use/2,[1,1]*yymax,...
                                'color','k',...
                                'linewidth',1.5);
                    ...
                    for ss = 1 : 2
                        ...
                        if alphas(aa) == max(alphas) && bb == n_coeffs2plot
                            xstairs = ...
                                [x_offsets(coeffidcs2plot(1)),...
                                x_offsets(coeffidcs2plot),...
                                x_offsets(coeffidcs2plot(end)),...
                                x_offsets(coeffidcs2plot(end))+barwidth]-barwidth/2;
