...
ylabel('SD (a.u.)');
sd_ramp_boots = nanstd(MU_ramp,0,2);
sd_non_boots = nanstd(MU_non,0,2);
plot([0,1],[nanmean(sd_ramp_boots),nanmean(sd_non_boots)],...
    'color','k',...
    'linewidth',1.5);
errorbar(0,nanmean(sd_ramp_boots),nanstd(sd_ramp_boots),...
    'color','k',...
    'marker','o',...
    'markersize',7.5,...
    'markeredgecolor','k',...
    ...
    'linewidth',1.5,...
    'capsize',0);
errorbar(1,nanmean(sd_non_boots),nanstd(sd_non_boots),...
    'color','k',...
    'marker','o',...
    'markersize',7.5,...
    'markeredgecolor','k',...
