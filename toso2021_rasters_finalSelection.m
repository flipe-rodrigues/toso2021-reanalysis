...
for ii = 1 : n_cols
    set(sps(ii+n_cols*0),...
        'position',get(sps(ii+n_cols*0),'position')-[0,.035,0,0]);
    set(sps(ii+n_cols*2),...
        'position',get(sps(ii+n_cols*2),'position')-[0,.035,0,0]);
end
...
for nn = 1 : n_neurons2plot
    ...
    for ii = 1 : n_i
        ...
        patch(sps(nn+n_cols*0),s1_xpatch,s1_ypatch,i1_clrs(ii,:),...
        ...
        patch(sps(nn+n_cols*0),s1_xpatch,s1_ypatch,0,...
            'facevertexalphadata',patch_alpha',...
            'alphadatamapping','none',...
            'edgealpha','interp',...
    ...
    for ii = 1 : n_i
        ...
        patch_alpha = patch_alpha * .25 + .05;
        patch(sps(nn+n_cols*2),s2_xpatch,s2_ypatch,i2_clrs(ii,:),...
            'facevertexalphadata',patch_alpha',...
            'alphadatamapping','none',...
            'facealpha','interp',...
            'edgecolor','none');
        ...
        patch_alpha = (patch_alpha - min(s2_trials_throughtime)) / ...
            range(s2_trials_throughtime);
        patch_alpha = patch_alpha * .95 + .05;
        patch(sps(nn+n_cols*2),s2_xpatch,s2_ypatch,0,...
            'facevertexalphadata',patch_alpha',...
            'alphadatamapping','none',...
            'edgealpha','interp',...
