...
for rr = 1 : n_runs
    ...
    for gg = 1 : n_glm
        ...
        ax_sig = axes(axesopt.default,...
            ...
            'xticklabel',strrep(coeffs2plot,'_',''),...
            'yticklabel',strrep(coeffs2plot,'_',''),...
        ...
        set(clrbar.Label,...
            clrlabel);
        set(ax_sig,...
            'position',[ax_sig.Position(1),ax_sig.Position(2),.075,.085]);
...
xxticklabel(~ismember(xxtick,[0,1e3,t_set(t2_mode_idx)])) = {''};
yylims = [.25,1];
yytick = [0,.05,.25,.5,.75,1]; % linspace(0,1,5);
yyticklabel = num2cell(yytick);
% yyticklabel(~ismember(yytick,unique([yylims,.05,.5]))) = {''};
pbaspectratio = [1,1,1];
axes(axesopt.default,...
