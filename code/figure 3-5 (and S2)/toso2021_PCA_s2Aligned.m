...
for nn = 1 : n_neurons
    ...
    for ii = 1 : n_contrasts
        ...
        % fetch spike counts & compute spike rates
        s2_spike_rates = data.SDF(s2_trial_flags,:);
        s2_n_trials = size(s2_spike_rates,1);
        
        % S2-aligned spike rates
        s2_alignment = ...
            pre_init_padding + ...
            pre_s1_delay(s2_trial_flags) + ...
            t1(s2_trial_flags) + ...
            isi;
        s2_alignment_flags = ...
            padded_time >= s2_alignment + roi2plot_padded(1) & ...
            padded_time < s2_alignment + t2(s2_trial_flags);
        s2_chunk_flags = ...
            padded_time >= s2_alignment + roi2plot_padded(1) & ...
