...
for kk = 1 : n_contrasts
    ...
    for ii = 1 : n_stimuli
        ...
        psycurves(kk).y(ii,1) = sum(idealized_choice(trial_flags));
...
for ii = 1 : n_stimuli
    ...
    bigpsy.y(ii,1) = sum(idealized_choice(trial_flags));
...
fig = figure(figopt,...
    'name',sprintf('idealized_psychometric_curves_%s',contrast_str));
