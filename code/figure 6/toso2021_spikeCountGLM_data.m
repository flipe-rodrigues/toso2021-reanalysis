...
for gg = 1 : n_glm
    ...
    for nn = 1 : n_neurons
        progressreport(nn,n_neurons,...
            sprintf('fetching spike counts (%i/%i)',gg,n_glm));
        ...
        if isfield(glm_roi,'aroundInitMov') && glm_win == glm_win2use
            alignment_onset = ...
        ...
        if isfield(glm_roi,'preInit') && glm_win == glm_win2use
            alignment_onset = ...
                repmat(pre_init_padding,n_trials,1);
            alignment_flags = ...
        ...
        if isfield(glm_roi,'postInit') && glm_win == glm_win2use
            alignment_onset = ...
                repmat(pre_init_padding,n_trials,1);
            alignment_flags = ...
        ...
        if isfield(glm_roi,'preS1Onset') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
        ...
        if isfield(glm_roi,'postS1Offset') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags);
        ...
        if isfield(glm_roi,'preS2Onset') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
        ...
        if isfield(glm_roi,'postS2Offset') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
        ...
        % pre-go spike rates
        if isfield(glm_roi,'preGoCue') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
        ...
        % post-go spike rates
        if isfield(glm_roi,'postGoCue') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
        ...
        if isfield(glm_roi,'aroundReaction') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
        ...
        if isfield(glm_roi,'aroundChoice') && glm_win == glm_win2use
            alignment_onset = ...
                pre_init_padding + ...
                pre_s1_delay(trial_flags) + ...
                t1(trial_flags) + ...
...
%% average spike counts as a function of window size

% figure initialization
fig = figure(figopt,...
    'position',[550,400,420,320],...
    'name','GLM_spikeCountMus',...
    'color',[1,1,1]*245/255);
...
for gg = 1 : n_glm
    ...
    mus_onset(gg) = nanmean(spkcounts.postS2Onset(gg,trial_flags));
    mus_offset(gg) = nanmean(spkcounts.preS2Offset(gg,trial_flags));
end
...
%% GLM window selection
glm_win =  glm_win2use;
glm_idx = find(glm_wins == glm_win);
glm_str = sprintf('t%i',glm_win);
spkcounts.postS1Onset = spkcounts.postS1Onset(glm_idx,:);
spkcounts.preS1Offset = spkcounts.preS1Offset(glm_idx,:);
spkcounts.postS2Onset = spkcounts.postS2Onset(glm_idx,:);
spkcounts.preS2Offset = spkcounts.preS2Offset(glm_idx,:);
