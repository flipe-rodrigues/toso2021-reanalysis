...
%
% histogram2(s2_coeff_neuron(:,1),s2_coeff_neuron(:,2),15,...
%     'displayStyle','tile',...
%     'showemptybins','on',...
%     'edgecolor','none');
nbins = 15;
xedges = linspace(...
    min(s2_coeff_neuron(:,1),[],'all'),...
    max(s2_coeff_neuron(:,1),[],'all'),nbins+1);
yedges = linspace(...
    min(s2_coeff_neuron(:,2),[],'all'),...
    max(s2_coeff_neuron(:,2),[],'all'),nbins+1);
rampcounts2 = histcounts2(...
    s2_coeff_neuron(s2_ramp_flags,1),s2_coeff_neuron(s2_ramp_flags,2),...
    'xbinedges',xedges,...
    'ybinedges',yedges);
noncounts2 = histcounts2(...
    s2_coeff_neuron(s2_nonramp_flags,1),s2_coeff_neuron(s2_nonramp_flags,2),...
    'xbinedges',xedges,...
    'ybinedges',yedges);
C = cat(3,rampcounts2',noncounts2');
P = tensor2rgb(C,ramp_clrs*0);
